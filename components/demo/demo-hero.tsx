    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden pt-20">
      ...
      <div className="container mx-auto max-w-6xl relative z-10 py-12">
        <div className="text-center space-y-8">
          ...
          >
            <span className="text-white">Transform your business's</span>
            <br />
            <span className="bg-gradient-to-r from-purple-400 via-cyan-400 to-purple-600 bg-clip-text text-transparent">
              phone operations
            </span>
            <br />
            <span className="text-white">with AI-powered voice assistance</span>
          </motion.h1>
          ...
          >
            Experience firsthand how Nevox AI can revolutionize your customer interactions and streamline your operations.
          </motion.p>
