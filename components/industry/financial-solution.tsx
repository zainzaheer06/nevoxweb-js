...
import { Building, CreditCard, TrendingUp, Shield, ArrowRight } from "lucide-react"
...
export function FinancialSolution() {
  ...
  const features = [
    {
      ...
      description: "Provide seamless banking support with intelligent voice assistance.",
      items: [
    ...
    },
    {
      ...
      description: "Assist investors with portfolio management and market information.",
      items: [
        "Portfolio updates",
        "Market insights",
    ...
    },
    {
      ...
      description: "Enhance security with voice-enabled fraud detection and prevention.",
      items: [
  ...
  const stats = [
    { value: "45%", label: "Cost Reduction in Customer Service" },
    { value: "90%", label: "Authentication Accuracy" },
    { value: "30%", label: "Fraud Prevention Improvement" },
    { value: "3min", label: "Average Resolution Time" }
  ]

  return (
    <section id="financial" className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Transform customer service and banking operations with AI-powered voice agents that provide 
            secure, efficient, and personalized financial services support.
          </p>
        </motion.div>
