...
import { Plane, Calendar, Headphones, ArrowRight } from "lucide-react"
...
export function TravelSolution() {
  ...
  const features = [
    {
      ...
      description: "Streamline travel bookings with intelligent voice assistance.",
      items: ["Flight reservations and changes", "Hotel bookings", "Car rental arrangements", "Package deal assistance", "Price comparisons and alerts"]
    },
    {
      icon: Plane,
      title: "Travel Assistance",
      description: "Provide comprehensive travel support and information.",
      items: ["Itinerary management", "Travel documentation help", "Weather updates", "Local recommendations", "Emergency assistance"]
    },
    {
      icon: Headphones,
      title: "Customer Service",
      description: "Handle customer inquiries and support with AI efficiency.",
      items: ["24/7 customer support", "Cancellation assistance", "Refund processing", "Loyalty program management", "Feedback collection"]
    }
  ]

  const stats = [
    { value: "55%", label: "Booking Efficiency Increase" },
  ...
  return (
    <section id="travel" className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10" ref={ref}>
        <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }} transition={{ duration: 0.8 }} className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Travel & Tourism Solutions</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">Transform travel experiences with AI voice agents that streamline bookings, provide 24/7 travel assistance, and deliver personalized customer support throughout the journey.</p>
        </motion.div>
