...
import { UtensilsCrossed, ShoppingCart, Users, Settings, ArrowRight } from "lucide-react"

export function RestaurantSolution() {
  ...
  const features = [
    {
      ...
      description: "Streamline the entire ordering process with intelligent voice assistance.",
      items: ["24/7 phone order taking", "Multi-language order support", "Customization and special requests", "Order modification handling", "Upselling suggestions"]
    },
    {
      icon: Users,
      title: "Customer Experience",
      description: "Enhance customer satisfaction with personalized service.",
      items: ["Table reservations", "Menu information and recommendations", "Dietary restrictions handling", "Loyalty program management", "Customer feedback collection"]
    },
    {
      icon: Settings,
      title: "Operations Management",
      description: "Optimize kitchen and staff operations with voice automation.",
      items: ["Inventory tracking and alerts", "Staff scheduling assistance", "Kitchen order coordination", "Delivery dispatch management", "Quality control monitoring"]
    }
  ]
  ...
  const stats = [
    ...
    { value: "28%", label: "Increase in Order Value" },
    { value: "92%", label: "Order Accuracy Rate" }
  ]

  return (
    <section id="restaurants" className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10" ref={ref}>
        <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }} transition={{ duration: 0.8 }} className="text-center mb-16">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-r from-purple-500 to-cyan-500 mb-6">
            <UtensilsCrossed className="w-10 h-10 text-white" />
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Restaurant Solutions</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">Transform your restaurant operations with AI voice agents that streamline ordering, enhance customer service, and optimize kitchen operations while reducing costs and improving efficiency.</p>
        </motion.div>
