      ...
      <div className="container mx-auto max-w-6xl relative z-10 py-12">
        <div className="text-center space-y-8">
          ...
          >
            ...
            Leading AI Voice Technology Company
          </motion.div>
          ...
          >
            We're transforming how businesses connect with their customers through advanced AI voice technology, 
            making exceptional service accessible to all.
          </motion.p>
